...
function Home(){
  ...
  return (
    <>
        ...
        <Typography variant="h4" fontWeight="bold" > Sapper Hack </Typography>
        </div>     
        ...
        <div className='book' style={{padding:"10px"}}>
            <Card style={{paddingTop:"0em", background:"#5f9ea0", color:"black", height:"10rem", borderRadius:"20px", display:"flex", flexDirection:"column", height:"180px"}}>
            <CardContent  style={{display:"flex"}} >
